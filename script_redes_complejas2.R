...
# Regla 2: Quitar las conexiones con el peso más bajo, nos vamos a quedar con las del peso máximo (menos conexiones)
...
M = as.matrix(
  read.csv("C:\\Users\\yunh_\\Desktop\\DOCTORADO\\3er. SEMESTRE\\COMPLEJIDAD ECONÓMICA\\Tareas\\Laboratorios\\Lab 11\\relatednessbinario.csv" , 
           sep = ",", 
           header = T, 
           row.names = 1))
...
M <- -M
head (M[,1:6])
#Transforma la matriz en NEGATIVA y para identificar los máximos
